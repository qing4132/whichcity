...
# Chinese cities: AQI values are US EPA equivalent (raw AQICN * ~1.3-1.5)

new_cities = [
    # Chinese cities (5)
    make_city(101, "广州", "中国", "亚洲", 52000, 1600, 4.35, 5200, 120, 3.2,
        "中国南方经济重镇，珠三角核心城市。制造业和贸易发达，美食文化丰富。气候炎热潮湿。", 0.88),
    make_city(102, "深圳", "中国", "亚洲", 60000, 1800, 4.50, 7800, 95, 2.8,
        "中国科技创新之都，腾讯、华为等巨头总部所在地。年轻、活力四射的现代化城市。", 1.02),
    make_city(103, "成都", "中国", "亚洲", 42000, 1200, 3.80, 2800, 115, 3.5,
        "中国西南中心城市，以美食和休闲文化闻名。新兴科技中心，生活成本相对较低。", 0.72),
    make_city(104, "杭州", "中国", "亚洲", 55000, 1650, 4.20, 5500, 100, 3.3,
        "阿里巴巴总部所在地，中国电商与互联网产业重镇。西湖闻名世界，宜居城市。", 0.94),
    make_city(105, "重庆", "中国", "亚洲", 38000, 1100, 3.60, 2200, 110, 2.9,
        "中国西南最大直辖市，山城地形独特。制造业和物流中心，生活成本较低，美食丰富。", 0.65),

    # Japan (2)
    make_city(106, "大阪", "日本", "亚洲", 58000, 2200, 4.15, 4800, 38, 2.6,
        "日本第二大都市圈，商业与美食之都。生活成本低于东京，文化独特热情奔放。", 0.82),
    make_city(107, "名古屋", "日本", "亚洲", 52000, 1900, 4.00, 3200, 35, 2.5,
        "日本中部工业重镇，丰田汽车总部所在地。生活成本适中，制造业就业机会丰富。", 0.75),

    # South Korea (1)
    make_city(108, "仁川", "韩国", "亚洲", 42000, 1600, 4.50, 3800, 55, 2.4,
    ...
    make_city(112, "清迈", "泰国", "亚洲", 18000, 750, 3.50, 1500, 70, 0.8,
