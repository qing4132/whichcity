...
new_cities = [
    ...
    # Southeast Asia (5)
    make_city(109, "金边", "柬埔寨", "亚洲", 12000, 650, None, 1800, 75, 0.2,
        "柬埔寨首都，东南亚新兴经济体。房地产和旅游业增长迅速，生活成本极低。", 0.20),
    make_city(110, "仰光", "缅甸", "亚洲", 8000, 500, None, 800, 85, 0.7,
        "缅甸最大城市和经济中心。历史建筑丰富，生活成本极低但基础设施有待发展。", 0.14),
    make_city(111, "万象", "老挝", "亚洲", 9000, 550, None, 900, 60, 0.4,
    ...
    # South Asia (3)
    make_city(114, "达卡", "孟加拉国", "亚洲", 10000, 500, None, 1200, 170, 0.5,
    ...
    make_city(116, "加德满都", "尼泊尔", "亚洲", 8500, 450, None, 700, 135, 0.3,
    ...
    make_city(120, "乌兰巴托", "蒙古", "亚洲", 14000, 700, None, 1000, 155, 3.0,
