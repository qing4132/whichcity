...
展示单个城市的 10 个关键指标卡片（收入、成本、储蓄、房价、巨无霸价格、年工作时长、AQI、安全指数、医生数、直飞城市），分两行每行 5 个显示。卡片边框按百分位着色（绿=前25%，红=后25%，默认=中间）。收入/成本随顶栏的职业和消费层级动态变化。还包含气候信息和相关城市对比链接。
...
| `CityDetailContent.tsx` | ~240 | 城市详情页（统一顶栏，10 个百分位着色卡片，气候） |
