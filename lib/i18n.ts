...
export const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    safetyMethodNote: "ℹ️ 体感安全指数计算方法：40% 夜间安全感 + 30% 暴力犯罪反向 + 20% 财产犯罪反向 + 10% 外国人友好度，0–100 分，越高越安全",
  ...
  en: {
    ...
    safetyMethodNote: "ℹ️ Safety Index formula: 40% Night Safety + 30% Violent Crime (inv.) + 20% Property Crime (inv.) + 10% Foreigner Friendliness, 0–100, higher = safer",
  ...
  ja: {
    ...
    safetyMethodNote: "ℹ️ 安全指数の計算: 40% 夜間安全感 + 30% 暴力犯罪(逆) + 20% 財産犯罪(逆) + 10% 外国人友好度、0–100、高いほど安全",
  ...
  es: {
    ...
    safetyMethodNote: "ℹ️ Fórmula del índice: 40% Seguridad nocturna + 30% Crimen violento (inv.) + 20% Crimen patrimonial (inv.) + 10% Amabilidad con extranjeros, 0–100, mayor = más seguro",
