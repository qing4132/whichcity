...
const VN: Record<string, L3> = {
    ...
    "Digital Nomad Visa (D-visa)": { zh: "数字游民签证 (D签证)", ja: "デジタルノマドビザ (Dビザ)", es: "Visa Nómada Digital (Visa D)" },
...
const TX: Record<string, L3> = {
    ...
    "0% if <183 days; 50% tax reduction program for 7 years if resident": { zh: "停留<183天免税；居民享7年50%减税", ja: "183日未満0%；居住者7年間50%減税", es: "0% si <183 días; 50% reducción 7 años si residente" },
    ...
    "20% flat if staying >183 days (worldwide income)": { zh: "停留>183天按全球收入征20%", ja: "183日超で全世界所得20%", es: "20% fijo si >183 días (ingreso mundial)" },
    "6%-35% on income paid/remitted in Korea; tax treaties may exempt": { zh: "韩国汇入收入6%-35%；税收协定可免", ja: "韓国送金所得6%-35%；条約で免除あり", es: "6%-35% ingresos remitidos; tratados pueden eximir" },
};
...
const NT: Record<string, L4> = {
    ...
    jp_2024: { en: "Launched March 2024. Applicants must be from visa-exempt or tax treaty countries. Health insurance ≥¥10M required.", zh: "2024年3月推出。申请人须来自免签国或税收协定国，需购买保额≥1000万日元的医疗保险。", ja: "2024年3月開始。ビザ免除国または租税条約国の国民が対象で、保険金額1000万円以上の医療保険が必要です。", es: "Lanzada en marzo de 2024. Los solicitantes deben ser de países exentos de visa o con tratado fiscal. Se requiere seguro médico ≥¥10M." },
    th_dtv: { en: "5-year multiple-entry visa. Each stay up to 180 days, extendable by 180 days. Requires 500,000 THB (~$14,000) in savings. SMART Visa also available for skilled workers.", zh: "5年多次入境，每次可停留180天并延期180天。需50万泰铢（约$14,000）存款证明。高技能人才也可申请 SMART 签证。", ja: "5年間有効のマルチエントリービザで、1回の滞在は最長180日＋180日延長可能。50万バーツ（約$14,000）の残高証明が必要。高スキル人材にはSMART Visaもあります。", es: "Visa de 5 años con entradas múltiples. Cada estancia hasta 180 días, extensible 180 días más. Se requieren 500,000 THB (~$14,000) en ahorros. También existe la SMART Visa para profesionales cualificados." },
    es_beckham: { en: "Initially 12 months, renewable up to 5 years. Reduced tax rate under the Beckham Law.", zh: "首次签发12个月，最长可续至5年。可享受「贝克汉姆法」减税优惠。", ja: "初回12ヶ月、最長5年まで更新可能。「ベッカム法」による減税優遇が適用されます。", es: "12 meses iniciales, renovable hasta 5 años. Tipo impositivo reducido bajo la Ley Beckham." },
    br_vitem: { en: "Valid for 1 year, renewable for another year. Requires $1,500/month income or $18,000 in savings.", zh: "有效期1年，可续签1年。需月收入≥$1,500或存款≥$18,000。", ja: "有効期間1年、さらに1年更新可能。月収$1,500以上、または預金$18,000以上が必要です。", es: "Válida por 1 año, renovable otro año. Se requiere un ingreso de $1,500/mes o $18,000 en ahorros." },
    it_pending: { en: "Legislated in March 2022, but implementation details remain unpublished.", zh: "2022年3月已立法通过，但具体实施细则至今未公布。", ja: "2022年3月に法制化されましたが、具体的な実施細則はまだ公表されていません。", es: "Aprobada por ley en marzo de 2022, pero los detalles de implementación aún no se han publicado." },
    ...
    kr_company: { en: "Only for remote workers employed by a company. Freelancers are not eligible. Valid up to 2 years.", zh: "仅限受雇于企业的远程工作者，自由职业者不符合条件。有效期最长2年。", ja: "企業に所属するリモートワーカー限定で、フリーランサーは対象外です。有効期間は最長2年。", es: "Solo para trabajadores remotos empleados por una empresa. Los freelancers no son elegibles. Válida hasta 2 años." },
    vn_evisa: { en: "Tourist e-visa allows stays of up to 90 days.", zh: "旅游电子签证最长可停留90天。", ja: "観光用の電子ビザ（e-visa）で最長90日間滞在できます。", es: "La visa electrónica de turismo permite estancias de hasta 90 días." },
    pt_popular: { en: "Applications open since October 2022. First 6 months are tax-free.", zh: "2022年10月起可申请，入境前6个月免征所得税。", ja: "2022年10月から申請受付中。最初の6ヶ月間は所得税が免除されます。", es: "Solicitudes abiertas desde octubre de 2022. Los primeros 6 meses están exentos de impuestos." },
    mx_temp: { en: "Nomad-friendly temporary resident visa available. 180-day tourist visa also commonly used.", zh: "可申请对游民友好的临时居民签证，也可持180天旅游签入境。", ja: "ノマドに適した一時居住ビザがあり、180日間の観光ビザも広く利用されています。", es: "Hay una visa de residente temporal apta para nómadas. También se usa comúnmente la visa de turista de 180 días." },
    co_2yr: { en: "Valid for up to 2 years.", zh: "有效期最长2年。", ja: "有効期間は最長2年。", es: "Válida hasta 2 años." },
    za_pending: { en: "Announced in 2024 but not yet implemented. Details still under development.", zh: "2024年已宣布但尚未正式实施，细则仍在制定中。", ja: "2024年に発表されましたが、まだ実施されていません。詳細は策定中です。", es: "Anunciada en 2024 pero aún no implementada. Los detalles siguen en desarrollo." },
    ...
    pe_tourist: { en: "Tourist stay of up to 183 days.", zh: "可凭旅游身份停留最长183天。", ja: "観光目的で最長183日間滞在できます。", es: "Estancia turística de hasta 183 días." },
    my_pass: { en: "3-12 month pass, renewable for another 12 months. Limited to digital and tech professions.", zh: "通行证有效期3-12个月，可续签12个月。仅限数字和科技类职业申请。", ja: "3〜12ヶ月のパスで、さらに12ヶ月更新可能。デジタル・テック系の職種に限定されています。", es: "Pase de 3 a 12 meses, renovable por otros 12. Solo para profesiones digitales y tecnológicas." },
    ...
    id_b211a: { en: "5-year tax-free nomad visa plan announced in June 2022. B211A visa commonly used by nomads.", zh: "2022年6月宣布5年免税游民签证计划，目前游民多使用 B211A 签证入境。", ja: "2022年6月に5年間の免税ノマドビザ計画が発表されました。現在はB211Aビザが広く利用されています。", es: "Plan de visa nómada de 5 años libre de impuestos anunciado en junio de 2022. La visa B211A es la más utilizada por nómadas." },
    ...
    gr_extend: { en: "Extendable to a total of 2 years.", zh: "可延长至总计2年。", ja: "合計2年まで延長可能。", es: "Extensible hasta un total de 2 años." },
    ...
    uae_virtual: { en: "Valid for 1 year. Requires $5,000/month income and an employment confirmation letter. 0% income tax.", zh: "有效期1年，需月收入≥$5,000并提供雇佣证明信，所得税为0%。", ja: "有効期間1年。月収$5,000以上と雇用確認書が必要。所得税は0%。", es: "Válida por 1 año. Se requiere un ingreso de $5,000/mes y carta de empleo. Impuesto sobre la renta: 0%." },
    ph_announced: { en: "Announced in May 2023, valid for 1 year.", zh: "2023年5月宣布推出，有效期1年。", ja: "2023年5月に発表。有効期間は1年。", es: "Anunciada en mayo de 2023, válida por 1 año." },
    tw_2025: { en: "Launched January 2025, valid for 180 days. Requires prior nomad visa experience, 6-month average savings ≥$10,000, and annual income $20,000–$40,000 (varies by age).", zh: "2025年1月推出，有效期180天。需有其他国家游民签证经历，近6个月平均存款≥$10,000，年收入$20,000-$40,000（因年龄而异）。", ja: "2025年1月開始、有効期間180日。他国でのノマドビザ経験、直近6ヶ月の平均預金$10,000以上、年収$20,000〜$40,000（年齢による）が必要です。", es: "Lanzada en enero de 2025, válida por 180 días. Requiere experiencia previa con visa nómada, depósitos promedio de $10,000 en 6 meses y salario de $20,000–$40,000/año (según edad)." },
    ar_6mo: { en: "Valid for 6 months, renewable for another 6 months. Launched May 2022.", zh: "有效期6个月，可续签6个月。2022年5月推出。", ja: "有効期間6ヶ月、さらに6ヶ月更新可能。2022年5月開始。", es: "Válida por 6 meses, renovable otros 6. Lanzada en mayo de 2022." },
    cr_1yr: { en: "Valid for 1 year, renewable for another year. Requires $3,000/month income ($5,000 for families). Law passed August 2021.", zh: "有效期1年，可续签1年。需月收入≥$3,000（家庭≥$5,000）。2021年8月立法通过。", ja: "有効期間1年、さらに1年更新可能。月収$3,000以上（家族は$5,000以上）が必要。2021年8月に法制化。", es: "Válida por 1 año, renovable otro año. Se requiere un ingreso de $3,000/mes (familias $5,000). Ley aprobada en agosto de 2021." },
    ...
    ua_conflict: { en: "Was a popular nomad destination before the 2022 conflict.", zh: "2022年冲突前曾是热门游民目的地。", ja: "2022年の紛争前はノマドに人気の目的地でした。", es: "Era un destino popular para nómadas antes del conflicto de 2022." },
    ro_6mo: { en: "Valid for 6 months, renewable for another 6 months. Requires 3+ years of work experience and income ≥3× Romania's average gross salary. First 6 months tax-free.", zh: "有效期6个月，可续签6个月。需3年以上工作经验，且收入≥罗马尼亚平均工资的3倍。入境前6个月免税。", ja: "有効期間6ヶ月、さらに6ヶ月延長可能。3年以上の職歴とルーマニア平均総給の3倍以上の収入が必要。最初の6ヶ月は非課税。", es: "Válida por 6 meses, renovable otros 6. Requiere más de 3 años de experiencia laboral e ingresos ≥3× el salario bruto medio rumano. Primeros 6 meses libres de impuestos." },
    rs_90day: { en: "90-day visa-free stay available for many nationalities.", zh: "多数国籍可免签停留90天。", ja: "多くの国籍が90日間のビザ免除で滞在できます。", es: "Estancia de 90 días sin visa para muchas nacionalidades." },
    hu_1yr: { en: "Valid for 1 year, renewable for another year. First 6 months tax-free.", zh: "有效期1年，可续签1年。据 VisaGuide，入境前6个月可免税。", ja: "有効期間1年、さらに1年更新可能。最初の6ヶ月間は非課税。", es: "Válida por 1 año, renovable otro año. Los primeros 6 meses están exentos de impuestos." },
    kz_30day: { en: "30-day visa-free entry for many nationalities.", zh: "多数国籍可免签停留30天。", ja: "多くの国籍が30日間のビザ免除で入国できます。", es: "Entrada sin visa de 30 días para muchas nacionalidades." },
    ...
    ge_suspended: { en: "Program appears suspended as of January 2025. Only open to citizens of 95 visa-free countries.", zh: "截至2025年1月该项目疑似已暂停，且仅限95个免签国公民申请。", ja: "2025年1月時点でプログラムは一時停止の模様。ビザ免除対象の95カ国の国民のみ申請可能。", es: "El programa parece suspendido desde enero de 2025. Solo para ciudadanos de 95 países con exención de visa." },
    ...
    uy_90day: { en: "90-day visa-free stay for strong passports. Temporary residency for remote workers available via consulate.", zh: "强护照可免签停留90天，也可通过领事馆申请远程工作者临时居留。", ja: "強いパスポートなら90日間ビザ免除で滞在可能。領事館を通じてリモートワーカー向けの一時居住を申請できます。", es: "Estancia de 90 días sin visa para pasaportes fuertes. Se puede solicitar residencia temporal para trabajadores remotos a través del consulado." },
    ma_90day: { en: "90-day visa-free entry for US/EU/UK passports. 3-month extension possible at local police station.", zh: "美/欧/英护照可免签停留90天，可在当地警局延期3个月。", ja: "米国/EU/英国のパスポートで90日間ビザ免除。地元の警察署で3ヶ月の延長が可能です。", es: "Entrada sin visa de 90 días para pasaportes de EE. UU./UE/Reino Unido. Extensión de 3 meses posible en la comisaría local." },
};
...
const VP: Record<string, L3> = {
    ...
    "Many VPN providers blocked since 2024": { zh: "2024年起大量 VPN 服务被封锁。", ja: "2024年以降多くのVPNプロバイダーがブロック。", es: "Muchos proveedores VPN bloqueados desde 2024." },
};
